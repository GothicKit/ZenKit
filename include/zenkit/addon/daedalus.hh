...
namespace zenkit {
	...
	struct ISvm : DaedalusInstance {
		var string mil_greetings;
		var string pal_greetings;
		var string weather;
		var string iget_you_still;
		var string die_enemy;
		var string die_monster;
		var string addon_die_monster;
		var string addon_die_monster_2;
		var string dirty_thief;
		var string hands_off;
		var string sheep_killer;
		var string sheep_killer_monster;
		var string you_murderer;
		var string die_stupid_beast;
		var string you_dare_hit_me;
		var string you_asked_for_it;
		var string then_ibeat_you_out_of_here;
		var string what_did_you_do_in_there;
		var string will_you_stop_fighting;
		var string kill_enemy;
		var string enemy_killed;
		var string monster_killed;
		var string addon_monster_killed;
		var string addon_monster_killed_2;
		var string thief_down;
		var string rumfummler_down;
		var string sheep_attacker_down;
		var string kill_murderer;
		var string stupid_beast_killed;
		var string never_hit_me_again;
		var string you_better_should_have_listened;
		var string get_up_and_begone;
		var string never_enter_room_again;
		var string there_is_no_fighting_here;
		var string spare_me;
		var string run_away;
		var string alarm;
		var string guards;
		var string help;
		var string good_monster_kill;
		var string good_kill;
		var string not_now;
		var string run_coward;
		var string get_out_of_here;
		var string why_are_you_in_here;
		var string yes_go_out_of_here;
		var string whats_this_supposed_to_be;
		var string you_disturbed_my_slumber;
		var string itook_your_gold;
		var string shit_no_gold;
		var string itake_your_weapon;
		var string what_are_you_doing;
		var string looking_for_trouble_again;
		var string stop_magic;
		var string isaid_stop_magic;
		var string weapon_down;
		var string isaid_weapon_down;
		var string wise_move;
		var string next_time_youre_in_for_it;
		var string oh_my_head;
		var string theres_afight;
		var string oh_my_god_its_afight;
		var string good_victory;
		var string not_bad;
		var string oh_my_god_hes_down;
		var string cheer_friend_01;
		var string cheer_friend_02;
		var string cheer_friend_03;
		var string ooh_01;
		var string ooh_02;
		var string ooh_03;
		var string what_was_that;
		var string get_out_of_my_bed;
		var string awake;
		var string abs_commander;
		var string abs_monastery;
		var string abs_farm;
		var string abs_good;
		var string sheep_killer_crime;
		...
		var string oc_crime;
		var string toughguy_attack_lost;
		var string toughguy_attack_won;
		var string toughguy_player_attack;
		...
		var string gold_20;
		var string gold_10;
		var string smalltalk_01;
		var string smalltalk_02;
		var string smalltalk_03;
		var string smalltalk_04;
		var string smalltalk_05;
		var string smalltalk_06;
		var string smalltalk_07;
		var string smalltalk_08;
		var string smalltalk_09;
		var string smalltalk_10;
		var string smalltalk_11;
		var string smalltalk_12;
		var string smalltalk_13;
		var string smalltalk_14;
		var string smalltalk_15;
		var string smalltalk_16;
		var string smalltalk_17;
		var string smalltalk_18;
		var string smalltalk_19;
		var string smalltalk_20;
		var string smalltalk_21;
		var string smalltalk_22;
		var string smalltalk_23;
		var string smalltalk_24;
		var string smalltalk_25;
		var string smalltalk_26;
		var string smalltalk_27;
		var string smalltalk_28;
		var string smalltalk_29;
		var string smalltalk_30;
		var string no_learn_no_points;
		var string no_learn_over_personal_max;
		var string no_learn_youre_better;
		var string you_learned_something;
		...
		var string aargh_2;
		var string aargh_3;
		var string addon_wrong_armor;
		var string addon_wrong_armor_sld;
		var string addon_wrong_armor_mil;
		var string addon_wrong_armor_kdf;
		var string addon_no_armor_bdt;
		var string addon_die_bandit;
		var string addon_dirty_pirate;
		var string sc_hey_turn_around;
		var string sc_hey_turn_around_02;
		var string sc_hey_turn_around_03;
		var string sc_hey_turn_around_04;
		var string sc_hey_wait_asecond;
		var string doesnt_mork;
		var string pick_broke;
		var string need_key;
		var string no_more_picks;
		var string no_pick_lock_talent;
		var string no_sweeping;
		var string pick_lock_or_key_missing;
		var string key_missing;
		var string pick_lock_missing;
		var string never_open;
		var string missing_item;
		var string dont_know;
		var string nothing_to_get;
		var string nothing_to_get_02;
		var string nothing_to_get_03;
		var string heal_shrine;
		var string heal_last_shrine;
		var string irdorath_there_you_are;
		var string sc_opens_irdorath_book;
		var string sc_opens_last_door;
		var string trade_1;
		var string trade_2;
		var string trade_3;
		var string verstehe;
		var string found_treasure;
		var string cant_understand_this;
		var string cant_read_this;
		var string stoneplate_1;
		var string stoneplate_2;
		var string stoneplate_3;
		var string cough;
		var string hui;
		var string addon_this_little_bastard;
		var string addon_open_adanos_temple;
		var string attentat_addon_description;
		var string attentat_addon_description_2;
		var string attentat_addon_pro;
		var string attentat_addon_contra;
		var string mine_addon_description;
		var string addon_summon_ancient_ghost;
		var string addon_ancient_ghost_not_near;
		var string addon_gold_description;
		var string watch_your_aim;
		var string watch_your_aim_angry;
		var string lets_forget_our_little_fight;
		var string strange;
		var string die_mortal_enemy;
		var string now_wait;
		var string now_wait_intruder;
		var string you_still_not_have_enough;
		var string you_attacked_my_charge;
		var string iwill_teach_you_respect_for_foreign_property;
		var string you_killed_one_of_us;
		var string berzerk;
		var string youll_be_sorry_for_this;
		var string yes_yes;
		var string shit_what_amonster;
		var string we_will_meet_again;
		var string never_try_that_again;
		var string itook_your_ore;
		var string shit_no_ore;
		var string you_violated_forbidden_territory;
		var string you_wanna_fool_me;
		var string what_did_you_in_there;
		var string intruder_alert;
		var string behind_you;
		var string hey_hey_hey;
		var string cheer_fight;
		var string cheer_friend;
		var string ooh;
		var string yeah_well_done;
		var string he_defeatedhim;
		var string he_deserv_edit;
		var string he_killed_him;
		var string it_was_agood_fight;
		var string friendly_greetings;
		var string al_greetings;
		var string mage_greetings;
		var string sect_greetings;
		var string there_he_is;
		var string no_learn_over_max;
		var string no_learn_you_already_know;
		var string hey_you;
		var string what_do_you_want;
		var string isaid_what_do_you_want;
		var string make_way;
		var string out_of_my_way;
		var string you_deaf_or_what;
		var string look_away;
		var string okay_keep_it;
		var string whats_that;
		var string thats_my_weapon;
		var string give_it_tome;
		var string you_can_keep_the_crap;
		var string they_killed_my_friend;
		var string sucker_got_some;
		var string sucker_defeated_ebr;
		var string sucker_defeated_gur;
		var string sucker_defeated_mage;
		var string sucker_defeated_nov_guard;
		var string sucker_defeated_vlk_guard;
		var string you_defeated_my_comrade;
		var string you_defeated_nov_guard;
		var string you_defeated_vlk_guard;
		var string you_stole_from_me;
		var string you_stole_from_us;
		var string you_stole_from_ebr;
		var string you_stole_from_gur;
		var string stole_urom_mage;
		var string you_killedmyfriend;
		var string you_killed_ebr;
		var string you_killed_gur;
		var string you_killed_mage;
		var string you_killed_oc_folk;
		var string you_killed_nc_folk;
		var string you_killed_psi_folk;
		var string get_things_right;
		var string you_defeated_me_well;
		var string om;
