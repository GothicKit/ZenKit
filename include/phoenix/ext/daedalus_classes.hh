...
namespace phoenix::daedalus {
	...
	struct C_SVM {
		...
		static void register_(script& s) {
			// TODO:: OPTIONAL
			s.register_member("C_SVM.MILGREETINGS", &C_SVM::MILGREETINGS);
			s.register_member("C_SVM.PALGREETINGS", &C_SVM::PALGREETINGS);
			s.register_member("C_SVM.WEATHER", &C_SVM::WEATHER);
			s.register_member("C_SVM.IGETYOUSTILL", &C_SVM::IGETYOUSTILL);
			s.register_member("C_SVM.DIEENEMY", &C_SVM::DIEENEMY);
			s.register_member("C_SVM.DIEMONSTER", &C_SVM::DIEMONSTER);
			s.register_member("C_SVM.ADDON_DIEMONSTER", &C_SVM::ADDON_DIEMONSTER);
			s.register_member("C_SVM.ADDON_DIEMONSTER2", &C_SVM::ADDON_DIEMONSTER2);
			s.register_member("C_SVM.DIRTYTHIEF", &C_SVM::DIRTYTHIEF);
			s.register_member("C_SVM.HANDSOFF", &C_SVM::HANDSOFF);
			s.register_member("C_SVM.SHEEPKILLER", &C_SVM::SHEEPKILLER);
			s.register_member("C_SVM.SHEEPKILLERMONSTER", &C_SVM::SHEEPKILLERMONSTER);
			s.register_member("C_SVM.YOUMURDERER", &C_SVM::YOUMURDERER);
			s.register_member("C_SVM.DIESTUPIDBEAST", &C_SVM::DIESTUPIDBEAST);
			s.register_member("C_SVM.YOUDAREHITME", &C_SVM::YOUDAREHITME);
			s.register_member("C_SVM.YOUASKEDFORIT", &C_SVM::YOUASKEDFORIT);
			s.register_member("C_SVM.THENIBEATYOUOUTOFHERE", &C_SVM::THENIBEATYOUOUTOFHERE);
			s.register_member("C_SVM.WHATDIDYOUDOINTHERE", &C_SVM::WHATDIDYOUDOINTHERE);
			s.register_member("C_SVM.WILLYOUSTOPFIGHTING", &C_SVM::WILLYOUSTOPFIGHTING);
			s.register_member("C_SVM.KILLENEMY", &C_SVM::KILLENEMY);
			s.register_member("C_SVM.ENEMYKILLED", &C_SVM::ENEMYKILLED);
			s.register_member("C_SVM.MONSTERKILLED", &C_SVM::MONSTERKILLED);
			s.register_member("C_SVM.ADDON_MONSTERKILLED", &C_SVM::ADDON_MONSTERKILLED);
			s.register_member("C_SVM.ADDON_MONSTERKILLED2", &C_SVM::ADDON_MONSTERKILLED2);
			s.register_member("C_SVM.THIEFDOWN", &C_SVM::THIEFDOWN);
			s.register_member("C_SVM.RUMFUMMLERDOWN", &C_SVM::RUMFUMMLERDOWN);
			s.register_member("C_SVM.SHEEPATTACKERDOWN", &C_SVM::SHEEPATTACKERDOWN);
			s.register_member("C_SVM.KILLMURDERER", &C_SVM::KILLMURDERER);
			s.register_member("C_SVM.STUPIDBEASTKILLED", &C_SVM::STUPIDBEASTKILLED);
			s.register_member("C_SVM.NEVERHITMEAGAIN", &C_SVM::NEVERHITMEAGAIN);
			s.register_member("C_SVM.YOUBETTERSHOULDHAVELISTENED", &C_SVM::YOUBETTERSHOULDHAVELISTENED);
			s.register_member("C_SVM.GETUPANDBEGONE", &C_SVM::GETUPANDBEGONE);
			s.register_member("C_SVM.NEVERENTERROOMAGAIN", &C_SVM::NEVERENTERROOMAGAIN);
			s.register_member("C_SVM.THEREISNOFIGHTINGHERE", &C_SVM::THEREISNOFIGHTINGHERE);
			s.register_member("C_SVM.SPAREME", &C_SVM::SPAREME);
			s.register_member("C_SVM.RUNAWAY", &C_SVM::RUNAWAY);
			s.register_member("C_SVM.ALARM", &C_SVM::ALARM);
			s.register_member("C_SVM.GUARDS", &C_SVM::GUARDS);
			s.register_member("C_SVM.HELP", &C_SVM::HELP);
			s.register_member("C_SVM.GOODMONSTERKILL", &C_SVM::GOODMONSTERKILL);
			s.register_member("C_SVM.GOODKILL", &C_SVM::GOODKILL);
			s.register_member("C_SVM.NOTNOW", &C_SVM::NOTNOW);
			s.register_member("C_SVM.RUNCOWARD", &C_SVM::RUNCOWARD);
			s.register_member("C_SVM.GETOUTOFHERE", &C_SVM::GETOUTOFHERE);
			s.register_member("C_SVM.WHYAREYOUINHERE", &C_SVM::WHYAREYOUINHERE);
			s.register_member("C_SVM.YESGOOUTOFHERE", &C_SVM::YESGOOUTOFHERE);
			s.register_member("C_SVM.WHATSTHISSUPPOSEDTOBE", &C_SVM::WHATSTHISSUPPOSEDTOBE);
			s.register_member("C_SVM.YOUDISTURBEDMYSLUMBER", &C_SVM::YOUDISTURBEDMYSLUMBER);
			s.register_member("C_SVM.ITOOKYOURGOLD", &C_SVM::ITOOKYOURGOLD);
			s.register_member("C_SVM.SHITNOGOLD", &C_SVM::SHITNOGOLD);
			s.register_member("C_SVM.ITAKEYOURWEAPON", &C_SVM::ITAKEYOURWEAPON);
			s.register_member("C_SVM.WHATAREYOUDOING", &C_SVM::WHATAREYOUDOING);
			s.register_member("C_SVM.LOOKINGFORTROUBLEAGAIN", &C_SVM::LOOKINGFORTROUBLEAGAIN);
			s.register_member("C_SVM.STOPMAGIC", &C_SVM::STOPMAGIC);
			s.register_member("C_SVM.ISAIDSTOPMAGIC", &C_SVM::ISAIDSTOPMAGIC);
			s.register_member("C_SVM.WEAPONDOWN", &C_SVM::WEAPONDOWN);
			s.register_member("C_SVM.ISAIDWEAPONDOWN", &C_SVM::ISAIDWEAPONDOWN);
			s.register_member("C_SVM.WISEMOVE", &C_SVM::WISEMOVE);
			s.register_member("C_SVM.NEXTTIMEYOUREINFORIT", &C_SVM::NEXTTIMEYOUREINFORIT);
			s.register_member("C_SVM.OHMYHEAD", &C_SVM::OHMYHEAD);
			s.register_member("C_SVM.THERESAFIGHT", &C_SVM::THERESAFIGHT);
			s.register_member("C_SVM.OHMYGODITSAFIGHT", &C_SVM::OHMYGODITSAFIGHT);
			s.register_member("C_SVM.GOODVICTORY", &C_SVM::GOODVICTORY);
			s.register_member("C_SVM.NOTBAD", &C_SVM::NOTBAD);
			s.register_member("C_SVM.OHMYGODHESDOWN", &C_SVM::OHMYGODHESDOWN);
			s.register_member("C_SVM.CHEERFRIEND01", &C_SVM::CHEERFRIEND01);
			s.register_member("C_SVM.CHEERFRIEND02", &C_SVM::CHEERFRIEND02);
			s.register_member("C_SVM.CHEERFRIEND03", &C_SVM::CHEERFRIEND03);
			s.register_member("C_SVM.OOH01", &C_SVM::OOH01);
			s.register_member("C_SVM.OOH02", &C_SVM::OOH02);
			s.register_member("C_SVM.OOH03", &C_SVM::OOH03);
			s.register_member("C_SVM.WHATWASTHAT", &C_SVM::WHATWASTHAT);
			s.register_member("C_SVM.GETOUTOFMYBED", &C_SVM::GETOUTOFMYBED);
			s.register_member("C_SVM.AWAKE", &C_SVM::AWAKE);
			s.register_member("C_SVM.ABS_COMMANDER", &C_SVM::ABS_COMMANDER);
			s.register_member("C_SVM.ABS_MONASTERY", &C_SVM::ABS_MONASTERY);
			s.register_member("C_SVM.ABS_FARM", &C_SVM::ABS_FARM);
			s.register_member("C_SVM.ABS_GOOD", &C_SVM::ABS_GOOD);
			s.register_member("C_SVM.SHEEPKILLER_CRIME", &C_SVM::SHEEPKILLER_CRIME);
			s.register_member("C_SVM.ATTACK_CRIME", &C_SVM::ATTACK_CRIME);
			s.register_member("C_SVM.THEFT_CRIME", &C_SVM::THEFT_CRIME);
			s.register_member("C_SVM.MURDER_CRIME", &C_SVM::MURDER_CRIME);
			s.register_member("C_SVM.PAL_CITY_CRIME", &C_SVM::PAL_CITY_CRIME);
			s.register_member("C_SVM.MIL_CITY_CRIME", &C_SVM::MIL_CITY_CRIME);
			s.register_member("C_SVM.CITY_CRIME", &C_SVM::CITY_CRIME);
			s.register_member("C_SVM.MONA_CRIME", &C_SVM::MONA_CRIME);
			s.register_member("C_SVM.FARM_CRIME", &C_SVM::FARM_CRIME);
			s.register_member("C_SVM.OC_CRIME", &C_SVM::OC_CRIME);
			s.register_member("C_SVM.TOUGHGUY_ATTACKLOST", &C_SVM::TOUGHGUY_ATTACKLOST);
			s.register_member("C_SVM.TOUGHGUY_ATTACKWON", &C_SVM::TOUGHGUY_ATTACKWON);
			s.register_member("C_SVM.TOUGHGUY_PLAYERATTACK", &C_SVM::TOUGHGUY_PLAYERATTACK);
			s.register_member("C_SVM.GOLD_1000", &C_SVM::GOLD_1000);
			s.register_member("C_SVM.GOLD_950", &C_SVM::GOLD_950);
			s.register_member("C_SVM.GOLD_900", &C_SVM::GOLD_900);
			s.register_member("C_SVM.GOLD_850", &C_SVM::GOLD_850);
			s.register_member("C_SVM.GOLD_800", &C_SVM::GOLD_800);
			s.register_member("C_SVM.GOLD_750", &C_SVM::GOLD_750);
			s.register_member("C_SVM.GOLD_700", &C_SVM::GOLD_700);
			s.register_member("C_SVM.GOLD_650", &C_SVM::GOLD_650);
			s.register_member("C_SVM.GOLD_600", &C_SVM::GOLD_600);
			s.register_member("C_SVM.GOLD_550", &C_SVM::GOLD_550);
			s.register_member("C_SVM.GOLD_500", &C_SVM::GOLD_500);
			s.register_member("C_SVM.GOLD_450", &C_SVM::GOLD_450);
			s.register_member("C_SVM.GOLD_400", &C_SVM::GOLD_400);
			s.register_member("C_SVM.GOLD_350", &C_SVM::GOLD_350);
			s.register_member("C_SVM.GOLD_300", &C_SVM::GOLD_300);
			s.register_member("C_SVM.GOLD_250", &C_SVM::GOLD_250);
			s.register_member("C_SVM.GOLD_200", &C_SVM::GOLD_200);
			s.register_member("C_SVM.GOLD_150", &C_SVM::GOLD_150);
			s.register_member("C_SVM.GOLD_100", &C_SVM::GOLD_100);
			s.register_member("C_SVM.GOLD_90", &C_SVM::GOLD_90);
			s.register_member("C_SVM.GOLD_80", &C_SVM::GOLD_80);
			s.register_member("C_SVM.GOLD_70", &C_SVM::GOLD_70);
			s.register_member("C_SVM.GOLD_60", &C_SVM::GOLD_60);
			s.register_member("C_SVM.GOLD_50", &C_SVM::GOLD_50);
			s.register_member("C_SVM.GOLD_40", &C_SVM::GOLD_40);
			s.register_member("C_SVM.GOLD_30", &C_SVM::GOLD_30);
			s.register_member("C_SVM.GOLD_20", &C_SVM::GOLD_20);
			s.register_member("C_SVM.GOLD_10", &C_SVM::GOLD_10);
			s.register_member("C_SVM.SMALLTALK01", &C_SVM::SMALLTALK01);
			s.register_member("C_SVM.SMALLTALK02", &C_SVM::SMALLTALK02);
			s.register_member("C_SVM.SMALLTALK03", &C_SVM::SMALLTALK03);
			s.register_member("C_SVM.SMALLTALK04", &C_SVM::SMALLTALK04);
			s.register_member("C_SVM.SMALLTALK05", &C_SVM::SMALLTALK05);
			s.register_member("C_SVM.SMALLTALK06", &C_SVM::SMALLTALK06);
			s.register_member("C_SVM.SMALLTALK07", &C_SVM::SMALLTALK07);
			s.register_member("C_SVM.SMALLTALK08", &C_SVM::SMALLTALK08);
			s.register_member("C_SVM.SMALLTALK09", &C_SVM::SMALLTALK09);
			s.register_member("C_SVM.SMALLTALK10", &C_SVM::SMALLTALK10);
			s.register_member("C_SVM.SMALLTALK11", &C_SVM::SMALLTALK11);
			s.register_member("C_SVM.SMALLTALK12", &C_SVM::SMALLTALK12);
			s.register_member("C_SVM.SMALLTALK13", &C_SVM::SMALLTALK13);
			s.register_member("C_SVM.SMALLTALK14", &C_SVM::SMALLTALK14);
			s.register_member("C_SVM.SMALLTALK15", &C_SVM::SMALLTALK15);
			s.register_member("C_SVM.SMALLTALK16", &C_SVM::SMALLTALK16);
			s.register_member("C_SVM.SMALLTALK17", &C_SVM::SMALLTALK17);
			s.register_member("C_SVM.SMALLTALK18", &C_SVM::SMALLTALK18);
			s.register_member("C_SVM.SMALLTALK19", &C_SVM::SMALLTALK19);
			s.register_member("C_SVM.SMALLTALK20", &C_SVM::SMALLTALK20);
			s.register_member("C_SVM.SMALLTALK21", &C_SVM::SMALLTALK21);
			s.register_member("C_SVM.SMALLTALK22", &C_SVM::SMALLTALK22);
			s.register_member("C_SVM.SMALLTALK23", &C_SVM::SMALLTALK23);
			s.register_member("C_SVM.SMALLTALK24", &C_SVM::SMALLTALK24);
			s.register_member("C_SVM.SMALLTALK25", &C_SVM::SMALLTALK25);
			s.register_member("C_SVM.SMALLTALK26", &C_SVM::SMALLTALK26);
			s.register_member("C_SVM.SMALLTALK27", &C_SVM::SMALLTALK27);
			s.register_member("C_SVM.SMALLTALK28", &C_SVM::SMALLTALK28);
			s.register_member("C_SVM.SMALLTALK29", &C_SVM::SMALLTALK29);
			s.register_member("C_SVM.SMALLTALK30", &C_SVM::SMALLTALK30);
			s.register_member("C_SVM.NOLEARNNOPOINTS", &C_SVM::NOLEARNNOPOINTS);
			s.register_member("C_SVM.NOLEARNOVERPERSONALMAX", &C_SVM::NOLEARNOVERPERSONALMAX);
			s.register_member("C_SVM.NOLEARNYOUREBETTER", &C_SVM::NOLEARNYOUREBETTER);
			s.register_member("C_SVM.YOULEARNEDSOMETHING", &C_SVM::YOULEARNEDSOMETHING);
			s.register_member("C_SVM.UNTERSTADT", &C_SVM::UNTERSTADT);
			s.register_member("C_SVM.OBERSTADT", &C_SVM::OBERSTADT);
			s.register_member("C_SVM.TEMPEL", &C_SVM::TEMPEL);
			s.register_member("C_SVM.MARKT", &C_SVM::MARKT);
			s.register_member("C_SVM.GALGEN", &C_SVM::GALGEN);
			s.register_member("C_SVM.KASERNE", &C_SVM::KASERNE);
			s.register_member("C_SVM.HAFEN", &C_SVM::HAFEN);
			s.register_member("C_SVM.WHERETO", &C_SVM::WHERETO);
			s.register_member("C_SVM.OBERSTADT_2_UNTERSTADT", &C_SVM::OBERSTADT_2_UNTERSTADT);
			s.register_member("C_SVM.UNTERSTADT_2_OBERSTADT", &C_SVM::UNTERSTADT_2_OBERSTADT);
			s.register_member("C_SVM.UNTERSTADT_2_TEMPEL", &C_SVM::UNTERSTADT_2_TEMPEL);
			s.register_member("C_SVM.UNTERSTADT_2_HAFEN", &C_SVM::UNTERSTADT_2_HAFEN);
			s.register_member("C_SVM.TEMPEL_2_UNTERSTADT", &C_SVM::TEMPEL_2_UNTERSTADT);
			s.register_member("C_SVM.TEMPEL_2_MARKT", &C_SVM::TEMPEL_2_MARKT);
			s.register_member("C_SVM.TEMPEL_2_GALGEN", &C_SVM::TEMPEL_2_GALGEN);
			s.register_member("C_SVM.MARKT_2_TEMPEL", &C_SVM::MARKT_2_TEMPEL);
			s.register_member("C_SVM.MARKT_2_KASERNE", &C_SVM::MARKT_2_KASERNE);
			s.register_member("C_SVM.MARKT_2_GALGEN", &C_SVM::MARKT_2_GALGEN);
			s.register_member("C_SVM.GALGEN_2_TEMPEL", &C_SVM::GALGEN_2_TEMPEL);
			s.register_member("C_SVM.GALGEN_2_MARKT", &C_SVM::GALGEN_2_MARKT);
			s.register_member("C_SVM.GALGEN_2_KASERNE", &C_SVM::GALGEN_2_KASERNE);
			s.register_member("C_SVM.KASERNE_2_MARKT", &C_SVM::KASERNE_2_MARKT);
			s.register_member("C_SVM.KASERNE_2_GALGEN", &C_SVM::KASERNE_2_GALGEN);
			s.register_member("C_SVM.HAFEN_2_UNTERSTADT", &C_SVM::HAFEN_2_UNTERSTADT);
			s.register_member("C_SVM.DEAD", &C_SVM::DEAD);
			s.register_member("C_SVM.AARGH_1", &C_SVM::AARGH_1);
			s.register_member("C_SVM.AARGH_2", &C_SVM::AARGH_2);
			s.register_member("C_SVM.AARGH_3", &C_SVM::AARGH_3);
			s.register_member("C_SVM.ADDON_WRONGARMOR", &C_SVM::ADDON_WRONGARMOR);
			s.register_member("C_SVM.ADDON_WRONGARMOR_SLD", &C_SVM::ADDON_WRONGARMOR_SLD);
			s.register_member("C_SVM.ADDON_WRONGARMOR_MIL", &C_SVM::ADDON_WRONGARMOR_MIL);
			s.register_member("C_SVM.ADDON_WRONGARMOR_KDF", &C_SVM::ADDON_WRONGARMOR_KDF);
			s.register_member("C_SVM.ADDON_NOARMOR_BDT", &C_SVM::ADDON_NOARMOR_BDT);
			s.register_member("C_SVM.ADDON_DIEBANDIT", &C_SVM::ADDON_DIEBANDIT);
			s.register_member("C_SVM.ADDON_DIRTYPIRATE", &C_SVM::ADDON_DIRTYPIRATE);
			s.register_member("C_SVM.SC_HEYTURNAROUND", &C_SVM::SC_HEYTURNAROUND);
			s.register_member("C_SVM.SC_HEYTURNAROUND02", &C_SVM::SC_HEYTURNAROUND02);
			s.register_member("C_SVM.SC_HEYTURNAROUND03", &C_SVM::SC_HEYTURNAROUND03);
			s.register_member("C_SVM.SC_HEYTURNAROUND04", &C_SVM::SC_HEYTURNAROUND04);
			s.register_member("C_SVM.SC_HEYWAITASECOND", &C_SVM::SC_HEYWAITASECOND);
			s.register_member("C_SVM.DOESNTWORK", &C_SVM::DOESNTWORK);
			s.register_member("C_SVM.PICKBROKE", &C_SVM::PICKBROKE);
			s.register_member("C_SVM.NEEDKEY", &C_SVM::NEEDKEY);
			s.register_member("C_SVM.NOMOREPICKS", &C_SVM::NOMOREPICKS);
			s.register_member("C_SVM.NOPICKLOCKTALENT", &C_SVM::NOPICKLOCKTALENT);
			s.register_member("C_SVM.NOSWEEPING", &C_SVM::NOSWEEPING);
			s.register_member("C_SVM.PICKLOCKORKEYMISSING", &C_SVM::PICKLOCKORKEYMISSING);
			s.register_member("C_SVM.KEYMISSING", &C_SVM::KEYMISSING);
			s.register_member("C_SVM.PICKLOCKMISSING", &C_SVM::PICKLOCKMISSING);
			s.register_member("C_SVM.NEVEROPEN", &C_SVM::NEVEROPEN);
			s.register_member("C_SVM.MISSINGITEM", &C_SVM::MISSINGITEM);
			s.register_member("C_SVM.DONTKNOW", &C_SVM::DONTKNOW);
			s.register_member("C_SVM.NOTHINGTOGET", &C_SVM::NOTHINGTOGET);
			s.register_member("C_SVM.NOTHINGTOGET02", &C_SVM::NOTHINGTOGET02);
			s.register_member("C_SVM.NOTHINGTOGET03", &C_SVM::NOTHINGTOGET03);
			s.register_member("C_SVM.HEALSHRINE", &C_SVM::HEALSHRINE);
			s.register_member("C_SVM.HEALLASTSHRINE", &C_SVM::HEALLASTSHRINE);
			s.register_member("C_SVM.IRDORATHTHEREYOUARE", &C_SVM::IRDORATHTHEREYOUARE);
			s.register_member("C_SVM.SCOPENSIRDORATHBOOK", &C_SVM::SCOPENSIRDORATHBOOK);
			s.register_member("C_SVM.SCOPENSLASTDOOR", &C_SVM::SCOPENSLASTDOOR);
			s.register_member("C_SVM.TRADE_1", &C_SVM::TRADE_1);
			s.register_member("C_SVM.TRADE_2", &C_SVM::TRADE_2);
			s.register_member("C_SVM.TRADE_3", &C_SVM::TRADE_3);
			s.register_member("C_SVM.VERSTEHE", &C_SVM::VERSTEHE);
			s.register_member("C_SVM.FOUNDTREASURE", &C_SVM::FOUNDTREASURE);
			s.register_member("C_SVM.CANTUNDERSTANDTHIS", &C_SVM::CANTUNDERSTANDTHIS);
			s.register_member("C_SVM.CANTREADTHIS", &C_SVM::CANTREADTHIS);
			s.register_member("C_SVM.STONEPLATE_1", &C_SVM::STONEPLATE_1);
			s.register_member("C_SVM.STONEPLATE_2", &C_SVM::STONEPLATE_2);
			s.register_member("C_SVM.STONEPLATE_3", &C_SVM::STONEPLATE_3);
			s.register_member("C_SVM.COUGH", &C_SVM::COUGH);
			s.register_member("C_SVM.HUI", &C_SVM::HUI);
			s.register_member("C_SVM.ADDON_THISLITTLEBASTARD", &C_SVM::ADDON_THISLITTLEBASTARD);
			s.register_member("C_SVM.ADDON_OPENADANOSTEMPLE", &C_SVM::ADDON_OPENADANOSTEMPLE);
			s.register_member("C_SVM.ATTENTAT_ADDON_DESCRIPTION", &C_SVM::ATTENTAT_ADDON_DESCRIPTION);
			s.register_member("C_SVM.ATTENTAT_ADDON_DESCRIPTION2", &C_SVM::ATTENTAT_ADDON_DESCRIPTION2);
			s.register_member("C_SVM.ATTENTAT_ADDON_PRO", &C_SVM::ATTENTAT_ADDON_PRO);
			s.register_member("C_SVM.ATTENTAT_ADDON_CONTRA", &C_SVM::ATTENTAT_ADDON_CONTRA);
			s.register_member("C_SVM.MINE_ADDON_DESCRIPTION", &C_SVM::MINE_ADDON_DESCRIPTION);
			s.register_member("C_SVM.ADDON_SUMMONANCIENTGHOST", &C_SVM::ADDON_SUMMONANCIENTGHOST);
			s.register_member("C_SVM.ADDON_ANCIENTGHOST_NOTNEAR", &C_SVM::ADDON_ANCIENTGHOST_NOTNEAR);
			s.register_member("C_SVM.ADDON_GOLD_DESCRIPTION", &C_SVM::ADDON_GOLD_DESCRIPTION);
		}
	};
	...
	struct C_PARTICLEFXEMITKEY {
		...
		static void register_(script& s) {
			...
			s.register_member("C_PARTICLEFXEMITKEY.PFX_SHPDISTRIBWALKSPEED", &C_PARTICLEFXEMITKEY::PFX_SHPDISTRIBWALKSPEED);
			...
			s.register_member("C_PARTICLEFXEMITKEY.PFX_DIRMODETARGETFOR_S", &C_PARTICLEFXEMITKEY::PFX_DIRMODETARGETFOR_S);
			s.register_member("C_PARTICLEFXEMITKEY.PFX_DIRMODETARGETPOS_S", &C_PARTICLEFXEMITKEY::PFX_DIRMODETARGETPOS_S);
