...
namespace phoenix::vobs {
	void animate::parse(animate& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
		obj.start_on = ctx->read_bool(); // startOn
	}

	void item::parse(item& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
		obj.instance = ctx->read_string(); // itemInstance
	}

	void lens_flare::parse(lens_flare& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
		obj.fx = ctx->read_string(); // lensflareFX
	}

	void pfx_controller::parse(pfx_controller& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
	...
	void message_filter::parse(message_filter& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
	...
	void code_master::parse(code_master& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
		obj.target = ctx->read_string();               // triggerTarget
	...
	void mover_controller::parse(mover_controller& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
		obj.target = ctx->read_string(); // triggerTarget
	...
	void touch_damage::parse(touch_damage& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
	...
	void earthquake::parse(earthquake& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
