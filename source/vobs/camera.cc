...
namespace phoenix::vobs {
	std::unique_ptr<camera_trj_frame> camera_trj_frame::parse(std::unique_ptr<archive_reader>& ctx,
	...
	void cs_camera::parse(cs_camera& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
