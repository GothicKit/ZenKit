...
namespace phoenix::vobs {
	void trigger::parse(trigger& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
	...
	void trigger_mover::parse(trigger_mover& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
	...
	void trigger_list::parse(trigger_list& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		trigger::parse(obj, ctx, version);
	...
	void trigger_script::parse(trigger_script& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		trigger::parse(obj, ctx, version);
		obj.function = ctx->read_string(); // scriptFunc
	}

	void trigger_change_level::parse(trigger_change_level& obj,
	                                 std::unique_ptr<archive_reader>& ctx,
	...
	void trigger_world_start::parse(trigger_world_start& obj,
	                                std::unique_ptr<archive_reader>& ctx,
	                                game_version version) { //
		vob::parse(obj, ctx, version);
		obj.target = ctx->read_string();  // triggerTarget
	...
	void trigger_untouch::parse(trigger_untouch& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
		vob::parse(obj, ctx, version);
		obj.target = ctx->read_string(); // triggerTarget
	}
} // namespace phoenix::vobs