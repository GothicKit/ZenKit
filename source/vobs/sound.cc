...
namespace phoenix::vobs {
	void sound::parse(sound& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
	...
	void sound_daytime::parse(sound_daytime& obj, std::unique_ptr<archive_reader>& ctx, game_version version) {
