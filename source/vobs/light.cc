...
namespace phoenix::vobs {
	...
	light_preset light_preset::parse(std::unique_ptr<archive_reader>& ctx, game_version version) {
		light_preset preset {};
		light_preset::parse(preset, ctx, version);
		return preset;
	}

	void light::parse(phoenix::vobs::light& obj, std::unique_ptr<archive_reader>& ctx, phoenix::game_version version) {
