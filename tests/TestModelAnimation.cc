...
TEST_SUITE("ModelAnimation") {
	TEST_CASE("ModelAnimation.load(GOTHIC1)") {
		...
		auto box0 = anim.bbox;
		CHECK_EQ(box0.max, zenkit::Vec3 {46.33139419555664f, 67.0935287475586f, 49.88602828979492f});
		CHECK_EQ(box0.min, zenkit::Vec3 {-51.09061050415039f, -94.02226257324219f, -31.280731201171875f});
	...
	TEST_CASE("ModelAnimation.load(GOTHIC2)") {
		...
		auto box0 = anim.bbox;
		CHECK_EQ(box0.max, zenkit::Vec3 {46.33139419555664f, 67.0935287475586f, 49.88602828979492f});
		CHECK_EQ(box0.min, zenkit::Vec3 {-51.090614318847656f, -94.02226257324219f, -31.280733108520508f});
